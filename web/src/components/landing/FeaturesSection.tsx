      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[180px]">
          ...
          <ScrollAnimationWrapper delay={100} className="md:col-span-2 md:row-span-2">
            <div className="group relative h-full rounded-2xl border border-border/50 bg-gradient-to-br from-card via-card to-card/80 p-6 overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-[0_0_40px_-10px_hsl(var(--primary)/0.3)]">
          ...
          <ScrollAnimationWrapper delay={200}>
            <div className="group relative h-full rounded-2xl border border-border/50 bg-gradient-to-br from-card to-card/80 p-5 overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-[0_0_30px_-10px_hsl(var(--primary)/0.3)]">
              <TrophyVisual />
          ...
          <ScrollAnimationWrapper delay={400} className="md:col-span-2">
            <div className="group relative h-full rounded-2xl border border-border/50 bg-gradient-to-br from-card to-card/80 p-6 overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-[0_0_30px_-10px_hsl(var(--primary)/0.3)]">
              <BrainVisual />
