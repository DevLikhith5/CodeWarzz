  ...
  useEffect(() => {
    const fetchContestData = async () => {
      try {
        ...
        if (contestData.status !== 'UPCOMING' || contestData.isRegistered) { // Simple check, backend is source of truth
          try {
            ...
            setProblems(problemsRes.data.data.map((p: any) => ({
              ...
              solved: false, // Need to implement solved status check
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center animate-pulse">
          <div className="w-8 h-8 border-2 border-primary border-t-transparent rounded-full animate-spin mr-2" />
